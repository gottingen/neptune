    ...
    <div >
      ...
      <div class="flex_v_around">
        ...
        >
          ...
          <el-menu-item index="/discovery"><i class="iconfont icon-speechbubble"></i> 服务发现</el-menu-item>
          <el-menu-item index="/monitor"><i class="iconfont icon-icon"></i> 监控</el-menu-item>
